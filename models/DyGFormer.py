...
class DyGFormer(nn.Module):
    ...
    def forward(self, src_node_ids: np.ndarray, dst_node_ids: np.ndarray,edge_ids:np.ndarray,
        ...
        src_node_embeddings,dst_node_embeddings,src_neighbors = self.compute_src_dst_node_temporal_embeddings(src_node_ids,dst_node_ids, node_interact_times)
    ...
    def forward_with_neighbors(self, src_node_ids: np.ndarray, dst_node_ids: np.ndarray,edge_ids:np.ndarray,
        ...
        src_node_embeddings,dst_node_embeddings,src_neighbors = self.compute_src_dst_node_temporal_embeddings(src_node_ids,dst_node_ids, node_interact_times)
        ## src_neighbors shape (batch_size, num_neighbors + 1, node_feat_dim)
    ...
    def compute_src_dst_node_temporal_embeddings(self, src_node_ids: np.ndarray, dst_node_ids: np.ndarray, node_interact_times: np.ndarray):
        ...
        src_patches_nodes_neighbor_node_raw_features_proj = self.projection_layer['node'](src_patches_nodes_neighbor_node_raw_features)
        ...
        batch_size = len(src_patches_nodes_neighbor_node_raw_features_proj)
        src_num_patches = src_patches_nodes_neighbor_node_raw_features_proj.shape[1]
        ...
        patches_nodes_neighbor_node_raw_features = torch.cat([src_patches_nodes_neighbor_node_raw_features_proj, dst_patches_nodes_neighbor_node_raw_features], dim=1)
        ...
        return src_node_embeddings, dst_node_embeddings,src_patches_nodes_neighbor_node_raw_features
